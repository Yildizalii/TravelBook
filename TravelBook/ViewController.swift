...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        prepareHidingKeyboardTapGesture()
        prepareMapView()
    ...
    private func prepareHidingKeyboardTapGesture() {
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        if nameText.text == "" {
            let alert = UIAlertController(title: "Error ", message: "You must write location", preferredStyle: UIAlertController.Style.alert)
        ...
        if commentText.text == "" {
            ...
            let commentAlert = UIAlertController(title: "Error", message: "You must write comment", preferredStyle: UIAlertController.Style.alert)
            let okeyButton = UIAlertAction(title: "OK", style: UIAlertAction.Style.cancel, handler: nil)
            
            commentAlert.addAction(okeyButton)
